...
- Administrar existencias desde tarjetas con foto y accesos directos a editar o reponer. En los formularios también puedes buscar y elegir el artículo por foto, código, precio y existencias. Al crear o editar, previsualiza la foto principal y añade hasta ocho fotos reales (5 MB por foto), desde archivos o tomándolas con la cámara del celular; puedes quitar fotos seleccionadas antes de guardar. El carrito muestra un carrete de fotos reales, con zoom al pasar el mouse y desplazamiento horizontal en el celular.
...
En el detalle revisa fotos y disponibilidad, usa **Usar disponibles**, quita artículos con cantidad cero o agrega una alternativa. Para elegirla, busca el modelo y toca una tarjeta con foto, código, precio y existencias; después pulsa **Guardar ajustes y agregar alternativa**. Guarda los ajustes y acuerda los cambios con el cliente. Busca el número de solicitud en el chat recibido; el número del cliente solo estará en WhatsApp, no se obtiene automáticamente desde el enlace. Puedes copiar el resumen actualizado para responder y marcarlo como contactado. Las solicitudes no reservan ni descuentan unidades.
