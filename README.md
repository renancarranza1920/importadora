...
Para administrar, entra a `https://importadora-myrr4sgdikyma8ew9bmgcm.streamlit.app/?vista=admin` e inicia sesión. En **Solicitudes**, filtra por estado o cliente, revisa fotos y disponibilidad, usa **Usar disponibles**, quita artículos con cantidad cero o agrega una alternativa. Guarda los ajustes y acuerda los cambios con el cliente. Busca el número de solicitud en el chat recibido; el número del cliente solo estará en WhatsApp, no se obtiene automáticamente desde el enlace. Puedes copiar el resumen actualizado para responder y marcarlo como contactado. Las solicitudes no reservan ni descuentan unidades.
